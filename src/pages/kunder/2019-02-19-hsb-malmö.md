...
intro:
  blurbs:
    - Info: >+
        Data om skibe og data om kunder kan nu samkøres, så mægleren hurtigt kan
        finde potentielle skibe til kunden.
    ...
    - Info: >+
        Der arbejdes nu med sager, så hver sag bygges over en kundes henvendelse
        og inkluderer korrespondance, ønsker og andre relevante oplysninger.

      Rubrik: ALT PÅ ÉT STED
      image1:
        alt: kafeee
