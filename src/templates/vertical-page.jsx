		...
		<div className="container-fluid">
			<div className="row">
				<div className="col-12 col-md-6 hero-copy">
					<h1><strong>Öka din hit rate med Lime CRM</strong>
					</h1>
					<ul>
						<li>360 graders vy över kunderna med ERP-koppling och all kunddata samlad.
						</li>
						<li>Kampanjhantering för mässor, utskick och andra marknadsaktiviteter.
						</li>
						<li>Effektiv säljstyrning med klassificering och potential på kunderna i en enda vy.
						</li>
						<li>…och mycket mer.
						</li>
					</ul>
					<button className="btn btn-white"
						dataToggle="modal"
						dataTarget="#signupModal">Testa gratis</button>

				</div>
				<div className="col-12 col-md-6 d-none d-md-flex lp-hero-sales"></div>
			</div>
		</div>
	</section>
		<h2>{title}</h2>
